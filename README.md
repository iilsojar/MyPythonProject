курс Погружение в Python 2023-2024
семинары и домашнее задание
ДЗ №1
...
4. Программа загадывает число от 0 до 1000. Необходимо угадать число за 10 попыток. Программа должна подсказывать “больше” или “меньше”
